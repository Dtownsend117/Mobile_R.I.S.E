...
Although this digital assistant is nothing like JARVIS from the movies, RISE is still a great program to get started with if you decide to create your own digital assistant someday.
This digital assistant is far from complete and has a handful of issues. I stopped working on it due to schooling and work getting in the way so I recently made some changes to upload it here for anyone to download and work on.
----------------------------------------------------------------

HOW TO INSTALL R.I.S.E:
...
4.) There are no APIs or support for them (let me know if you get them to work)
----------------------------------------------------------------
...
FOR ADMINISTRATOR:
-When giving a copy, change each variation of 'Boss' and/or 'username' to what the user wants to be called
----------------------------------------------------------------
