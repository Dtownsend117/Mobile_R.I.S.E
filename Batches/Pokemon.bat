@echo off
echo \=========================================================================/                
echo  \    PokeBatch - The Pokemon experience designed by David Townsend II   /               
echo   \=====================================================================/
pause
                              
cls
echo Professor Oak approaches
echo Prof. Oak: Hello there, you must be the new trainee that ive heard a lot about. My name is Professor Oak.
echo Prof. Oak: Welcome to the wonderful world of Pokemon!
pause

:choosename
cls
echo Prof. Oak: Before I overwhelm you with too much information, I need to know your name. What is it?
set /p name=
pause
...
cls
echo Prof. Oak: So %name% what are you waiting for? It's time to choose your starter pokemon.
pause
...
cls
echo Prof. Oak: Oh.. wait.. there is one more to choose from.
pause
...
echo Prof. Oak: This will help you with your travels.
pause
...
echo 2) Go to the Pokemon Center
echo 3) Go to the Pokemon Lab
...
echo    !_____! !___! !_____!
echo.
echo You have entered the Pokemon Lab
